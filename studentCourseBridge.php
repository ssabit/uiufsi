...
if(isset($_POST['course'])&&isset($_POST['slot'])&&isset($_POST['day'])&&isset($_POST['section'])) {
    ...
    if (isset($_POST['insert'])) {
        ...
        $row = $sqldata->fetch_assoc();
        $slotID=$row['slot_id'];
        $sqlget = "INSERT INTO `studentcoursebridge`(`student_id`, `course_name`, `section`, `slot_id`,`day`,`room_number`) VALUES ('$id','$courseName','$sec','$slotID','$day','$room')";
...
if(isset($_POST['course'])) {
    if (isset($_POST['delete'])) {
        ...
        $sqlget = "DELETE FROM `studentcoursebridge` WHERE student_id='$id' AND course_name='$courseName'";
